...
typedef struct
{
	u16 charge_code,current_code,voltage_code;
	u16 remainder_charge;	
	float charge,current,voltage;
	char charge_percentage;
}LTC2944;
